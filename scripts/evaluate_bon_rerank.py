...
Usage (from final_project/):
    python -u scripts/evaluate_bon_rerank.py
    python -u scripts/evaluate_bon_rerank.py --n 3 --seed 42
"""
...
from inference import CHARACTERS, PERSONA_IDENTITY, PersonaPipeline
