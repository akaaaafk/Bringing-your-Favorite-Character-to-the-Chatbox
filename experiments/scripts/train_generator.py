...
Reads:
    data/processed/training_pairs.csv   (from experiments/scripts/build_training_pairs.py)

Writes:
    models/generator/                   (loaded by movie_persona.pipeline)

Usage:
    python experiments/scripts/train_generator.py
    python experiments/scripts/train_generator.py --epochs 3 --batch-size 4
"""
...
def main() -> None:
    ...
    if not PAIRS_PATH.exists():
        raise FileNotFoundError(
            ...
            "Run experiments/scripts/build_training_pairs.py first."
        )
